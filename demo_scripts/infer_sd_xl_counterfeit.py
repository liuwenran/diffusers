...
pipeline = StableDiffusionXLPipeline.from_pretrained("gsdf/CounterfeitXL")
...
prompt = "a boy, sports, smiling, cute, sunshine, perfect, extremely detailed, 8k"
...
folder_path = 'results/sd_xl_counterfeit/boy'
if not os.path.exists(folder_path):
    os.makedirs(folder_path)

for ind in range(10):
    image = pipeline(prompt, num_inference_steps=25, width=960, height=1280, generator=generator).images[0]
